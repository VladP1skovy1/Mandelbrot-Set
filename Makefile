...
SOURCES += parlcd.cpp component.cpp label.cpp scene.cpp scene_builder.cpp 
SOURCES += render_controller.cpp input_controller.cpp scene_manager.cpp shared_data.cpp set.cpp
SOURCES += leds_controller.cpp rgbled_controller.cpp
SOURCES += menu.cpp
...
#SSH_OPTIONS+=-o 'ProxyJump=piskovla@postel.felk.cvut.cz'
