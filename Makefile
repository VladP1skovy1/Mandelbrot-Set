...
SOURCES += parlcd.cpp component.cpp label.cpp scene.cpp scene_builder.cpp render_controller.cpp input_controller.cpp scene_manager.cpp shared_data.cpp set.cpp
SOURCES += menu.cpp
